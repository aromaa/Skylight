...
{
    class RoomItemWiredInTeam : RoomItemWiredCondition
    {
        public GameTeam Team;

        public RoomItemWiredInTeam(uint id, uint roomId, uint userId, Item baseItem, string extraData, int x, int y, double z, int rot, WallCoordinate wallCoordinate, Room room)
