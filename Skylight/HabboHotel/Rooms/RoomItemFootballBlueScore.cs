...
{
    class RoomItemFootballBlueScore : RoomItemFootballScore
    {
        public RoomItemFootballBlueScore(uint id, uint roomId, uint userId, Item baseItem, string extraData, int x, int y, double z, int rot, WallCoordinate wallCoordinate, Room room)
