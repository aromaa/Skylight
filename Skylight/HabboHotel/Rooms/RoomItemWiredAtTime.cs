...
{
    class RoomItemWiredAtTime : RoomItemWiredTrigger
    {
        public int Time;

        public RoomItemWiredAtTime(uint id, uint roomId, uint userId, Item baseItem, string extraData, int x, int y, double z, int rot, WallCoordinate wallCoordinate, Room room)
        ...
        {
            if (this.Room.RoomWiredManager.TimerCycle == this.Time)
            {
                this.Room.RoomWiredManager.WiredTrigger(this, null, new HashSet<uint>());
            }
