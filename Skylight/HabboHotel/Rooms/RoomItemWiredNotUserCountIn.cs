...
{
    class RoomItemWiredNotUserCountIn : RoomItemWiredCondition
    {
        public int UsersMin;
        public int UsersMax;

        public RoomItemWiredNotUserCountIn(uint id, uint roomId, uint userId, Item baseItem, string extraData, int x, int y, double z, int rot, WallCoordinate wallCoordinate, Room room)
