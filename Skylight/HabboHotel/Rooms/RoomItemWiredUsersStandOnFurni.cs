...
{
    class RoomItemWiredUsersStandOnFurni : RoomItemWiredCondition
    {
        public List<RoomItem> SelectedItems;

        public RoomItemWiredUsersStandOnFurni(uint id, uint roomId, uint userId, Item baseItem, string extraData, int x, int y, double z, int rot, WallCoordinate wallCoordinate, Room room)
