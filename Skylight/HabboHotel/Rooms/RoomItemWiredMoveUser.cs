...
{
    class RoomItemWiredMoveUser : RoomItemWiredAction
    {
        public List<RoomItem> SelectedItems;

        public RoomItemWiredMoveUser(uint id, uint roomId, uint userId, Item baseItem, string extraData, int x, int y, double z, int rot, WallCoordinate wallCoordinate, Room room)
        ...
        public void Effect(RoomUnitUser user)
        {
            user.ApplyEffect(4, 10);
        }
