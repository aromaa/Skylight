...
{
    class GuideRequestErrorComposer<T> : OutgoingHandlerPacket where T : GuideRequestErrorComposerHandler
    {
        ...
        {
            ServerMessage message = BasicUtilies.GetRevisionServerMessage(Revision.PRODUCTION_201601012205_226667486, r63cOutgoing.GuideRequestError);
