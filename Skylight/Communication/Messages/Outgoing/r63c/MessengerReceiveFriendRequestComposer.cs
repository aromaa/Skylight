...
{
    public class MessengerReceiveFriendRequestComposer<T> : OutgoingHandlerPacket where T : MessengerReceiveFriendRequestComposerHandler
    {
        ...
        {
            ServerMessage message = BasicUtilies.GetRevisionServerMessage(Revision.PRODUCTION_201601012205_226667486, r63cOutgoing.MessengerReceiveFriendRequest);
