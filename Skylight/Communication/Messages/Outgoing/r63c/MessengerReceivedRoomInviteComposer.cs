...
{
    class MessengerReceivedRoomInviteComposer<T> : OutgoingHandlerPacket where T : MessengerReceivedRoomInviteComposerHandler
    {
        ...
        {
            ServerMessage message = BasicUtilies.GetRevisionServerMessage(Revision.PRODUCTION_201601012205_226667486, r63cOutgoing.MessengerReceivedRoomInvite);
